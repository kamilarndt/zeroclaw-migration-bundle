...
mod tests {
    ...
    fn launchable_channels_include_signal_mattermost_qq_nextcloud_and_feishu() {
        ...
        channels.signal = Some(crate::config::SignalConfig {
        ...
        channels.qq = Some(crate::config::QQConfig {
            app_id: "app-id".into(),
        ...
        channels.qq = None;
        channels.nextcloud_talk = Some(crate::config::NextcloudTalkConfig {
        ...
        channels.feishu = Some(crate::config::FeishuConfig {
            app_id: "cli_123".into(),
            app_secret: "secret".into(),
            encrypt_key: None,
            verification_token: None,
            allowed_users: vec!["*".into()],
            receive_mode: crate::config::LarkReceiveMode::Websocket,
            port: None,
        });
        assert!(has_launchable_channels(&channels));
    }
