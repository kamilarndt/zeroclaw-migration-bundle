...
pub use traits::{
    ChatMessage, ChatRequest, ChatResponse, ConversationMessage, ParsedToolCall, Provider,
...
pub fn create_resilient_provider_with_options(
    ...
    .with_provider_model_aliases(reliability.provider_model_aliases.clone());
...
pub fn create_routed_provider_with_options(
    ...
    for name in &needed {
        let routed_credential = model_routes
            ...
            .and_then(|r| {
                r.api_key.as_ref().and_then(|raw_key: &String| {
