...
//!
//! Uses `rust-embed` to bundle the `web-workspace/dist/` directory
//! (symlinked to /home/commander/.zeroclaw/workspace/web/dist/) into the binary.
