...
pub struct LarkChannel {
    ...
    receive_mode: crate::config::LarkReceiveMode,
...
impl LarkChannel {
    ...
    fn new_with_platform(
        ...
        Self {
            ...
            mention_only,
            use_feishu: true,
            receive_mode: crate::config::LarkReceiveMode::default(),
    ...
    pub fn from_config(config: &crate::config::LarkConfig) -> Self {
...
impl Channel for LarkChannel {
    ...
    async fn listen(&self, tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> anyhow::Result<()> {
        use crate::config::LarkReceiveMode;
...
mod tests {
    ...
    fn lark_from_feishu_config_sets_feishu_platform() {
        use crate::config::{FeishuConfig, LarkReceiveMode};
    ...
    fn lark_reaction_url_matches_region() {
        ...
        let feishu_cfg = crate::config::FeishuConfig {
            app_id: "cli_app123".into(),
            app_secret: "secret456".into(),
            encrypt_key: None,
            verification_token: Some("vtoken789".into()),
            allowed_users: vec!["*".into()],
            receive_mode: crate::config::LarkReceiveMode::Webhook,
            port: Some(9898),
        };
