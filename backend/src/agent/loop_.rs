// Private submodules for agent loop organization
mod execution;
mod security;
mod streaming;

// Re-export public items from submodules
pub use security::scrub_credentials;
pub use streaming::DRAFT_CLEAR_SENTINEL;
...
pub async fn run(
    ...
    let mut tools_registry = tools::all_tools_with_runtime(
        ...
        runtime,
        mem.clone(),
        None, // hands: Option<Arc<crate::agent::hands::HandsDispatcher>>
        composio_key,
        composio_entity_id,
        &config.browser,
        &config.http_request,
