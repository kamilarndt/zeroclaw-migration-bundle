...
| `cpu_idle_threshold_percent` | `90` | CPU idle threshold (0-100) for scheduling memory hygiene tasks |
...
- CPU-aware scheduling allows memory hygiene to run only when system is idle to minimize performance impact.
